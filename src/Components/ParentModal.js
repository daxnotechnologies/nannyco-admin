                    ...
                    <div className="relative bg-gray-300 rounded-lg shadow">
                        ...
                        <div className="py-6 px-6 lg:px-8">
                            ...
                            <form className="space-y-6" action="#">
                                <div>
                                    <input type="text" className="bg-gray-50 border border-gray-500 text-black placeholder:text-black text-sm rounded-lg block w-full p-2.5" placeholder="Parent Name" required="" />
                                </div>
                                <div>
                                ...
                                <div className='flex '>
                                    <input type="text" className="mr-2  bg-gray-50 border border-gray-500 text-black placeholder:text-black text-sm rounded-lg block w-3/4 p-2.5" placeholder="Parent Phone No" required="" />
                                    <input type="text" className="bg-gray-50 border border-gray-500 text-black placeholder:text-black text-sm rounded-lg block w-3/4 p-2.5" placeholder="Parent Email" required="" />
                                </div>
                                <div className='flex'>
                                ...
                                <div className='flex justify-around'>
                                    <button type="button" class="text-white bg-[#7E66AD] border border-[#7E66AD] font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Save</button>
